...
[NOTE]
====
{PRODUCT} {ENTERPRISE_VERSION} does not support integration with {FUSE_LONG} on Apache Karaf. If you want to integrate {PRODUCT} with {FUSE_LONG} on Apache Karaf, use {PRODUCT} 7.9 with {FUSE_LONG} 7.7.
====
