...
** In a high-availability deployment, additional resources according to the configured defaults are required for the Red Hat AMQ and Red Hat Data Grid pods.
