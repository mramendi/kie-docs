...
include::{enterprise-dir}/openshift/template-version-upgrade-con.adoc[leveloffset=+1]
include::{enterprise-dir}/openshift/imagestreams-upgrade-proc.adoc[leveloffset=+2]
...
ifdef::PAM[]
include::{enterprise-dir}/openshift/rhpam710-trial-ephemeral-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam710-authoring-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam710-authoring-ha-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam710-prod-immutable-monitor-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam710-prod-immutable-kieserver-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam710-prod-immutable-kieserver-amq-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam710-kieserver-externaldb-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam710-kieserver-mysql-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam710-kieserver-postgresql-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam710-managed-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam710-prod-ref.adoc[leveloffset=+2]
endif::PAM[]
ifdef::DM[]
include::{enterprise-dir}/openshift/rhdm710-trial-ephemeral-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhdm710-authoring-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhdm710-authoring-ha-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhdm710-kieserver-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhdm710-prod-immutable-kieserver-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhdm710-prod-immutable-kieserver-amq-ref.adoc[leveloffset=+2]
endif::DM[]
