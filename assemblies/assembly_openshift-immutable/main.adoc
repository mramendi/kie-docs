...
[NOTE]
====
Since {PRODUCT} version 7.5, support for {OPENSHIFT} 3.x is deprecated, including installation using all templates. New features might not be added, and this functionality will be removed in a future release.
====

[NOTE]
====
Templates are not supported for use with {OPENSHIFT} 4.x. To deploy {PRODUCT} on {OPENSHIFT} 4.x, see the instructions in {URL_DEPLOYING_OPENSHIFT_OPERATOR}[_{DEPLOYING_OPENSHIFT_OPERATOR}_].
====
...
ifdef::PAM[]
include::{enterprise-dir}/openshift/rhpam76-prod-immutable-monitor-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam76-prod-immutable-kieserver-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam76-prod-immutable-kieserver-amq-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam76-kieserver-externaldb-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam76-kieserver-mysql-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam76-kieserver-postgresql-ref.adoc[leveloffset=+2]
endif::PAM[]
ifdef::DM[]
include::{enterprise-dir}/openshift/rhdm76-prod-immutable-kieserver-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhdm76-prod-immutable-kieserver-amq-ref.adoc[leveloffset=+2]
endif::DM[]
