...
[NOTE]
====
Since {PRODUCT} version 7.5, support for {OPENSHIFT} 3.x, including installation using all templates and using the Automation Broker (Ansible Playbook) is deprecated. New features might not be added, and this functionality will be removed in a future release. 
====
...
ifdef::PAM[]
include::{enterprise-dir}/openshift/rhpam74-prod-immutable-monitor-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam74-prod-immutable-kieserver-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam74-prod-immutable-kieserver-amq-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam74-kieserver-externaldb-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam74-kieserver-mysql-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam74-kieserver-postgresql-ref.adoc[leveloffset=+2]
endif::PAM[]
ifdef::DM[]
include::{enterprise-dir}/openshift/rhdm74-prod-immutable-kieserver-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhdm74-prod-immutable-kieserver-amq-ref.adoc[leveloffset=+2]
endif::DM[]
