...
include::{enterprise-dir}/openshift/offline-settings-proc.adoc[leveloffset=+2]


include::{enterprise-dir}/openshift/template-overview-con.adoc[leveloffset=+1]
ifdef::PAM[]
include::{enterprise-dir}/openshift/rhpam71-prod-immutable-monitor-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam71-prod-immutable-kieserver-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam71-kieserver-externaldb-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam71-kieserver-mysql-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/openshift/rhpam71-kieserver-postgresql-ref.adoc[leveloffset=+2]
endif::PAM[]
ifdef::DM[]
include::{enterprise-dir}/openshift/rhdm71-prod-immutable-kieserver-ref.adoc[leveloffset=+2]
endif::DM[]
