...
ifdef::PAM[]
* At least four gigabytes of memory must be available in the OpenShift cluster/namespace. (If you do not deploy monitoring infrastructure, two gigabytes can be sufficient).
endif::PAM[]
ifdef::DM[]
