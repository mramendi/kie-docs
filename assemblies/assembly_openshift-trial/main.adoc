...
ifdef::PAM[]
include::{enterprise-dir}/openshift/rhpam75-trial-ephemeral-ref.adoc[leveloffset=+2]
endif::PAM[]
ifdef::DM[]
include::{enterprise-dir}/openshift/rhdm75-trial-ephemeral-ref.adoc[leveloffset=+2]
endif::DM[]
