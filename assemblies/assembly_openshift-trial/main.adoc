...
ifdef::PAM[]
include::{enterprise-dir}/openshift/rhpam72-trial-ephemeral-ref.adoc[leveloffset=+2]
endif::PAM[]
ifdef::DM[]
include::{enterprise-dir}/openshift/rhdm72-trial-ephemeral-ref.adoc[leveloffset=+2]
endif::DM[]
