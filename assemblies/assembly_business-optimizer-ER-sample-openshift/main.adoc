...
include::{enterprise-dir}/openshift/imagestreams-file-install-proc.adoc[leveloffset=+3]
include::{enterprise-dir}/openshift/secrets-employeerostering-create-proc.adoc[leveloffset=+3]
