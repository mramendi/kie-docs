...
//include::{enterprise-dir}/product-development-guide/maven-repo-downloading-proc.adoc[leveloffset=+2]
include::{enterprise-dir}/admin-and-config/maven-ext-repo-using-proc.adoc[leveloffset=+2]
//include::{enterprise-dir}/product-development-guide/maven-settings-configuration-ref.adoc[leveloffset=+2]
include::{enterprise-dir}/admin-and-config/maven-managing-dependencies-proc.adoc[leveloffset=+2]
//include::{enterprise-dir}/product-development-guide/maven-integrated-dependencies-ref.adoc[leveloffset=+2]
//include::{enterprise-dir}/product-development-guide/-testing-dependencies-ref.adoc[leveloffset=+2]
