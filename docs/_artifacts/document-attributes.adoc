...
//For community source includes
:drools-dir: community/drools-docs/src/main/asciidoc
:jbpm-dir: community/jbpm-docs/src/main/asciidoc
:op-dir: community/optaplanner-wb-es-docs/src/main/asciidoc
:shared-dir: community/shared-kie-docs/src/main/asciidoc
