...
To deploy an immutable {KIE_SERVER}, use the `rhpam70-prod-immutable-kieserver.yaml` template file. You can extract this file from the `rhpam-7.0.0.GA-openshift-templates.zip` product deliverable file.
