...
To deploy a single authoring environment, use the `rhpam-70-authoring.yaml` template file. You can extract this file from the `rhpam-7.0.0.GA-openshift-templates.zip` product deliverable file.
