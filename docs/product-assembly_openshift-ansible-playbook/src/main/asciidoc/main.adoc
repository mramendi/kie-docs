...
= Deploying a {PRODUCT} {PRODUCT_VERSION} environment on {OPENSHIFT} using the Ansible playbook
...
the Ansible playbook to deploy the environment in an interactive process, setting all
