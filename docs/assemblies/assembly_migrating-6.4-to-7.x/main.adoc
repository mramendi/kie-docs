...
include::{enterprise-dir}/migration/migration-tool-7.0-con.adoc[leveloffset=+2]

:context: non-exec-server
include::{enterprise-dir}/migration/migration-tool-niogit-7.0-proc.adoc[leveloffset=+3]

:context: non-exec-server
include::{enterprise-dir}/migration/migration-tool-repo-7.0-proc.adoc[leveloffset=+3]
