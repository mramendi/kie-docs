...
include::{product-dir}/installation/product-versioning-con.adoc[leveloffset=+1]

include::{product-dir}/installation/patches-notifications-proc.adoc[leveloffset=+1]

include::{product-dir}/installation/patches-applying-proc.adoc[leveloffset=+1]

// For DM/PAM 7.1
//include::{product-dir}/installation/upgrading-minor-release-proc.adoc[leveloffset=+1]
