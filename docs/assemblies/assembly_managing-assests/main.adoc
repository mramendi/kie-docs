...
include::getting-started/assets-con.adoc[leveloffset=+1]

include::getting-started/assets-types-ref.adoc[leveloffset=+1]

include::getting-started/assets-creating-proc.adoc[leveloffset=+1]

include::admin-and-config/assets-renaming-proc.adoc[leveloffset=+1]

include::admin-and-config/assets-metadata-managing-proc.adoc[leveloffset=+1]

include::admin-and-config/assets-filtering-proc.adoc[leveloffset=+1]

include::admin-and-config/assets-unlocking-proc.adoc[leveloffset=+1]
