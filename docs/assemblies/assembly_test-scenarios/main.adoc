...
include::{product-dir}/project-data/test-scenarios-con.adoc[leveloffset=+1]
...
include::{product-dir}/project-data/test-scenarios-create-proc.adoc[leveloffset=+1]

include::{product-dir}/project-data/test-scenarios-GIVEN-proc.adoc[leveloffset=+2]

include::{product-dir}/project-data/test-scenarios-EXPECT-proc.adoc[leveloffset=+2]
