...
include::{product-dir}/openshift/environment-managed-con.adoc[leveloffset=+1]
include::{product-dir}/openshift/environment-managed-deploy-proc.adoc[leveloffset=+2]
include::{product-dir}/openshift/environment-managed-modify-proc.adoc[leveloffset=+2]
