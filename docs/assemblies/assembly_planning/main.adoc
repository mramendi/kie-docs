...
//include::{product-dir}/product-installation-guide/rules-authoring-assets-ref.adoc[leveloffset=+1]
...
include::{product-dir}/installation/components-con.adoc[leveloffset=+1]

//include::{product-dir}/product-installation-guide/business-optimizer-con.adoc[leveloffset=+2]
...
* https://access.redhat.com/articles/3405391[Red Hat Decision Manager 7 Component Details]
endif::[]
...
You can install {KIE_SERVER} in an Oracle Weblogic Server instance and then use the headless {PRODUCT_SHORT} controller and the REST API or the {KIE_SERVER} Java Client API to interact with {KIE_SERVER}.
...
You can install {KIE_SERVER} in an IBM WebSphere Application Server instance and then use the headless {PRODUCT_SHORT} controller to interact with {KIE_SERVER}.

=== Development platform option
Developers can develop assets in {PRODUCT}. However, you can optionally integrate Red Hat JBoss Developer Studio with Red Hat Process Automation Manager to enable developers to write complex applications and leverage code auto-completion.
...
include::{product-dir}/admin-and-config/maven-con.adoc[leveloffset=+2]
...
A runtime environment consists of one or more {KIE_SERVER} instances with or without {CENTRAL}. If {CENTRAL} is not installed, you can use the headless {PRODUCT_SHORT} controller and the REST API or the {KIE_SERVER} Java Client API to interact with {KIE_SERVERS}.
