...
include::{product-dir}/rules/guided-rules-create-proc.adoc[leveloffset=+1]

include::{product-dir}/rules/guided-rules-WHEN-proc.adoc[leveloffset=+2]

include::{product-dir}/rules/guided-rules-THEN-proc.adoc[leveloffset=+2]
