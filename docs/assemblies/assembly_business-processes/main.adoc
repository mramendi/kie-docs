...
include::{product-dir}/getting-started/interacting-with-processes-migrating-process-designer-proc.adoc[leveloffset=+1]
...
include::{product-dir}/getting-started/data-model-proc.adoc[leveloffset=+2]

include::{product-dir}/getting-started/business-process-proc.adoc[leveloffset=+1]

include::{product-dir}/rules/guided-rules-con.adoc[leveloffset=+1]

include::{product-dir}/getting-started/business-rules-proc.adoc[leveloffset=+2]

include::{product-dir}/rules/guided-decision-tables-con.adoc[leveloffset=+1]

include::{product-dir}/getting-started/decision-tables-proc.adoc[leveloffset=+2]

include::{product-dir}/getting-started/process-forms-proc.adoc[leveloffset=+1]

include::{product-dir}/getting-started/deploying-application-proc.adoc[leveloffset=+1]

include::{product-dir}/getting-started/executing-proc.adoc[leveloffset=+1]

include::{product-dir}/getting-started/monitoring-proc.adoc[leveloffset=+1]
