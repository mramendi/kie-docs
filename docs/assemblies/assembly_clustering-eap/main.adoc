...
include::{enterprise-dir}/installation/clustering-domain-con.adoc[leveloffset=+1]
...
include::{enterprise-dir}/installation/clustering-bc-configure-domain-proc.adoc[leveloffset=+2]
include::{enterprise-dir}/installation/clustering-bc-configure-host-proc.adoc[leveloffset=+2]
include::{enterprise-dir}/installation/clustering-bc-install-proc.adoc[leveloffset=+2]
...
include::{enterprise-dir}/installation/clustering-ps-configure-domain-proc.adoc[leveloffset=+2]
