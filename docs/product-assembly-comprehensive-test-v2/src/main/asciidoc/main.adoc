...
include::product-user-guide/data-objects-create-proc.adoc[leveloffset=+1]
...
include::product-migration-guide/chap-eap-migration.adoc[leveloffset=+1]

include::product-installation-guide/bxms-installing-con.adoc[leveloffset=+1]

include::product-administration-and-configuration-guide/sect-kie-server-router.adoc[leveloffset=+2]
