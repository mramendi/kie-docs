...
:DEPLOYING_AUTHORING_MANAGED_ON_OPENSHIFT: Deploying a {PRODUCT} {PRODUCT_VERSION} authoring or managed server environment on {OPENSHIFT}
:DEPLOYING_IMMUTABLE_ON_OPENSHIFT: Deploying a {PRODUCT} {PRODUCT_VERSION} immutable server environment on {OPENSHIFT}
:DEPLOYING_TRIAL_ON_OPENSHIFT: Deploying a {PRODUCT} {PRODUCT_VERSION} trial environment on {OPENSHIFT}
...
:URL_DEPLOYING_AUTHORING_MANAGED_ON_OPENSHIFT: {URL_BASE_ENTERPRISE}/deploying_a_{URL_COMPONENT_PRODUCT}_{ENTERPRISE_VERSION}_authoring_or_managed_server_environment_on_red_hat_openshift_container_platform
...
:URL_DEPLOYING_TRIAL_ON_OPENSHIFT: {URL_BASE_ENTERPRISE}/deploying_a_{URL_COMPONENT_PRODUCT}_{ENTERPRISE_VERSION}_trial_environment_on_red_hat_openshift_container_platform
