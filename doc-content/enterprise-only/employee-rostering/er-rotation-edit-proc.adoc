...
** *From* and *To* day and time: The exact time and duration of the shift. The day number is counted from the start of the rotation period.
** *Rotation employee*: The employee assigned to the shift by default. Select *Unassigned* if you do not want to assign any employee to this shift by default; in this case, the employee in the shift is determined by the rostering process in every case without a preferred value.
+
