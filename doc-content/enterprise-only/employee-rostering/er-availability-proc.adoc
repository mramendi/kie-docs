...
. To change an availability entry, double-ckick the entry. You can change the following settings:
** *From* and *To* date and time: The time span to which the availability entry applies.
** You can select *Unavailable*, *Desired*, or *Undesired* status from a drop-down list.
+
