...
* Google Chrome is installed in order to run the application with the suggested configuration. However, you can modify the configuration to use another web browser.
