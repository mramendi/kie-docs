...
* The kafka operator is up and running on an OpenShift cluster and you have administrator privilege for this cluster.
* You created a kafka cluster in the OpenShift project to which you are planning to deploy the server.
