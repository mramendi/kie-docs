...
You can add an additional managed {KIE_SERVER} to an authoring or managed environment.  Deploy the server in the same project as the {LOCAL_CENTRAL} deployment.
