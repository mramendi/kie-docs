...
In order for the {LOCAL_CENTRAL} to connect to the {KIE_SERVER}, you must enable the `OpenShiftStartupStrategy` setting for your environment, as described in <<startupstrategy-enable-proc>>.
