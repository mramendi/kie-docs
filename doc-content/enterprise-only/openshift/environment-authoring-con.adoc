...
* When a user deploys a service to the {KIE_SERVER}, the {KIE_SERVER} deployment is rolled out again. No user is able to deploy another service to the same {KIE_SERVER} until the roll-out completes. 
