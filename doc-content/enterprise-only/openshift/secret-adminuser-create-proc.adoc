...
The secret must contain the user name and password as literals. key name for the user name is `KIE_ADMIN_USER`. The key name for the password is `KIE_ADMIN_PWD`.
