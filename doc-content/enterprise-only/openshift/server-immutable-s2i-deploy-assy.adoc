...
You can enable JMS capabilities of the immutable {KIE_SERVER} to be able to interact with the server through JMS API, using an external AMQ message broker.
