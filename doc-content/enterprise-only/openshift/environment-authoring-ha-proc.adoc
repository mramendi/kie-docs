...
** *AMQ ImageStream Namespace* (`AMQ_IMAGE_STREAM_NAMESPACE`): Namespace in which the image stream for the AMQ scaledown controller image is installed. The default setting is `openshift`.
