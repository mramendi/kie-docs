...
----
+
. In the `src/main/resources` subdirectory of the project, edit the `configuration.properties` file. Replace `<bootstrap-hostname>`  with the address that the route for the Kafka server uses.
+
