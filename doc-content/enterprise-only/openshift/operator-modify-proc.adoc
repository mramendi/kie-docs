...
. Find the `Business Automation` operator line in the table and click `KieApp` in the line. Information about the environments that youdeployed using this operator is displayed.
