...
** *Git hooks directory* (`GIT_HOOKS_DIR`): The fully qualified name of a Git hooks directory, for example, `/opt/eap/standalone/data/kie/git/hooks`. You must provide this directory and mount it at this path; for instructions, see <<githooks-proc>>.
+
