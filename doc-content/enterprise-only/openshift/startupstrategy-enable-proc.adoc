...
In an environment deployed using {PRODUCT} authoring templates, {CENTRAL} manages one {KIE_SERVER}. The server pod can be scaled, but all the copies execute the same services.
