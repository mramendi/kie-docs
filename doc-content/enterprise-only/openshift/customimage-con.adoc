...
You can create custom images to add files to {KIE_SERVER} deployments. You must then push the images to your own container registry. When deploying {PRODUCT}, you can configure the operator to use the custom images.
